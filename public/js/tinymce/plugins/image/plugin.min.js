    ...
    function c(a,b,c){
        function d(a,c){
            return c=c||[],tinymce.each(a,function(a){
                ...
                a.menu?e.menu=d(a.menu):(e.value=a.value,b(e)),c.push(e)}),c}
        return d(a,c||[])
    }
    function d(b){
        return function(){var c=a.settings.image_list;
